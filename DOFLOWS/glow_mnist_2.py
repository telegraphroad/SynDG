...
Original file is located at
    https://colab.research.google.com/drive/1UziyyolHVtRVBQ8uUedoGFWsAE9iZhSs
...
optimizer = torch.optim.Adamax(model.parameters(), lr=1e-4, weight_decay=1e-6)
...
for i in pbar:
    ...
    if i % 100 == 1:
        ...
        with torch.no_grad():
            ...
            plt.figure(figsize=(10, 10))
            plt.imshow(np.transpose(tv.utils.make_grid(x_, nrow=num_classes).cpu().numpy(), (1, 2, 0)))
            plt.savefig(f"glow_mnist_{i}.png")
            plt.show()
